import { auth, db, collection, query, where, getDocs, doc, updateDoc, addDoc, serverTimestamp, orderBy, getDoc, onSnapshot } from './firebase-config.js';
...
async function viewSubmission(submissionId) {
    ...
    try {
        ...
        document.getElementById('submission-date').textContent = submission.submittedAt ? 
